...
## 🛠 Features & Implementation Note

- **Core Propagators:** Fresnel (Transfer Function and Impulse Response), Fraunhofer, and Angular Spectrum methods.
- **Atmospheric Modeling:** Subharmonic phase screen generation, $r_0$ scaling, and multi-plane propagation.
- **Advanced Tools:** Support for partial coherence (MCDOC), Zernike decomposition, and sampling constraint analysis.
